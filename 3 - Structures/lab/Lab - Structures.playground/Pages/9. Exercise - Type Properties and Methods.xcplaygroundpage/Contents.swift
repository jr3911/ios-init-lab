...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Chef Excellence", email: "excellence@pursuit.org", age: 22)
 ...
 */
User.logIn(user: User(userName: "Line Cook", email: "whatever@hotmail.com", age: 30))
